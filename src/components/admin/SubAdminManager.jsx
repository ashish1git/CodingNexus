...
const SubAdminManager = () => {
  ...
  const initialPermissions = {
    ...
    viewCompetitionSubmissions: true,
    manageCompetitionSubmissions: true,
    evaluateCompetitionSubmissions: true,
    deleteCompetitions: true,
    viewTickets: true,
    respondTickets: true,
    manageEvents: true,
    createEvents: true,
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-gray-900"
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-10 pr-10 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-gray-900"
                          placeholder="••••••••"
                        />
                        <button
                          type="button"
