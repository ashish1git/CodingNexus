...
async function sendEmail_Simple() {
  try {
    console.log('\n📧 Interview Shortlist Email - Beautiful Template');
    console.log('═'.repeat(65) + '\n');

    const email = '23106031@apsit.edu.in';
    const applicantName = 'Applicant'; // Will be personalized when fetched from form

    console.log(`📤 Sending beautiful email to: ${email}`);
    ...
    if (result.success) {
      ...
      console.log('   ✓ Q&A round description (simple & chill)');
      console.log('   ✓ "Coming soon" notice for time & venue');
      console.log('   ✓ Friendly, no-stress vibes');
